...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/nsf24/inventa_sim/src/pid)
  set(pid_DEVEL_PREFIX /home/nsf24/inventa_sim/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/nsf24/inventa_sim/install)
...
if(NOT "/home/nsf24/inventa_sim/devel/include;/home/nsf24/inventa_sim/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/nsf24/inventa_sim/devel/include;/home/nsf24/inventa_sim/src/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nsf24/inventa_sim/src/pid/${idir}'.  ${_report}")
    endif()
