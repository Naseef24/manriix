...
def generate_launch_description():
    ...
    use_foxglove_whitelist_arg = DeclareLaunchArgument(
        ...
        default_value='True',
        description='Use production-safe Foxglove whitelist.',
    )
    ...
    enable_remote_camera_monitor_arg = DeclareLaunchArgument(
        ...
        default_value='False',
        description=(
            'Start isolated low-rate remote camera compression. '
            'Default False for safe robot bring-up.'
        ),
    )
    ...
    remote_camera_monitor_delay_arg = DeclareLaunchArgument(
        ...
        default_value='20.0',
        description='Delay before remote camera compressor starts.',
    )
    ...
    use_foxglove_whitelist_arg = DeclareLaunchArgument(
        ...
        default_value='True',
        description=(
            'Use the production-safe Foxglove topic whitelist. '
            'Keep True on the robot; False is debug-only.'
        ),
    )
    ...
    visualization_include = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'use_foxglove_whitelist': use_foxglove_whitelist,
            'enable_remote_camera_monitor': enable_remote_camera_monitor,
            'remote_camera_monitor_delay': remote_camera_monitor_delay,
        }.items(),
    )
