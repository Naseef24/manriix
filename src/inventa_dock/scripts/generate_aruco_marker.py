...
def main():
  ...
  # Create the ArUco marker using generateImageMarker instead of drawMarker
  this_marker = cv2.aruco.generateImageMarker(this_aruco_dictionary, aruco_marker_id, 300)
