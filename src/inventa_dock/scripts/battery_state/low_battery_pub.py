...
In this case, the battery is a low battery.
-------
Publishing Topics:
...
class BatteryStatePublisher:
    ...
    def __init__(self):
        ...
        self.power_supply_status = BatteryState.POWER_SUPPLY_STATUS_NOT_CHARGING  # Not charging
    ...
    def get_battery_state(self, event=None):
        ...
        # Optional: Log battery state (uncomment if needed)
        rospy.loginfo(f"🔋 Low Battery: {self.percentage * 100}%, Voltage: {self.voltage}V")
